...
func (r *mockOracle) LookupAsn(net.IP) (string, error)     { return "Telstra Pty Ltd", nil }
...
func (r *mockOracle) IsLookupAsnEnabled() bool             { return true }
...
func TestJSONHandlers(t *testing.T) {
	...
	var tests = []struct {
		...
		{s.URL, `{"ip":"127.0.0.1","ip_decimal":2130706433,"country":"Elbonia","city":"Bornyasherk","asn":"Telstra Pty Ltd","hostname":"localhost"}`, 200},
